...
import type { SearchableProduct } from '@/app/feed-25/analise-produtos-pdf/types';

// Fallback para ícones customizados para garantir que não quebrem a renderização
