...
import {
   Bot, Database, Loader2, Wand2, CheckCircle, CircleDashed, ArrowRight, Store,
   RotateCcw, Check, Pencil, Save, ExternalLink, Sparkles, ArrowDown, PackageX,
   PlusCircle, Search, Trash2, Download, Info, Tablets, CalendarIcon, ChevronLeft,
   RefreshCw, DollarSign, XCircle, ChevronsLeft, ChevronRight, ChevronsRight,
   AlertTriangle, ShoppingCart, Package
 } from 'lucide-react';
...
import type { OrganizeResult, StandardizeListOutput, LookupResult, FeedEntry, UnprocessedItem, ProductDetail, ProductCategorySettings, Product, PurchaseList, PurchaseListItem } from '@/lib/types'
...
import { loadAppSettings, loadProducts, saveFeedEntry, loadAllFeedEntries, loadProductSettings, deleteFeedEntry, savePurchaseList } from '@/services/firestore';
...
export default function ComprasPage() {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            const excludedStatuses = ['PEDIDO_EM_TRANSITO', 'Entregue', 'Cancelado', 'Pagamento cancelado'];
