...
export default function StatusIderisPage() {
    ...
    const filteredData = useMemo(() => {
        ...
        if (dateRange?.from) {
            ...
            const toDate = dateRange.to ? dateFnsEndOfDay(dateRange.to) : endOfDay(dateRange.from);
    ...
    return (
        <div className="flex flex-col gap-8 p-4 md:p-8">
            <div>
                <h1 className="text-3xl font-bold font-headline">Consulta de Status na Ideris</h1>
                <p className="text-muted-foreground">
                    Acompanhe o status dos seus pedidos diretamente da API da Ideris.
                </p>
            </div>
                                        ...
                                        {paginatedData.length > 0 ? paginatedData.map((item) => {
                                            ...
                                            <TableRow key={(item as any).id}>
                                                ...
                                                <TableCell className="text-center">
                                                    <Button variant="outline" size="sm" onClick={() => router.push(`/sac?orderId=${(item as any).order_code}`)}>
