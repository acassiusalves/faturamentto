...
export const pagePermissions: Record<string, string[]> = {
    ...
    '/sac': ['admin', 'socio', 'sac'],
    '/memoria': ['admin', 'socio', 'financeiro'],
    '/mapeamento': ['admin', 'socio'],
    '/aprovacoes': ['admin', 'socio'],
    '/configuracoes': ['admin'],
    '/perfil': ['admin', 'socio', 'financeiro', 'expedicao', 'sac'],
    '/feed-25': ['admin', 'socio', 'financeiro', 'expedicao', 'sac'],
    '/feed-25/lista': ['admin', 'socio', 'financeiro', 'expedicao', 'sac'],
    '/feed-25/analise-produtos-pdf': ['admin', 'socio', 'financeiro', 'expedicao', 'sac'],
    '/feed-25/buscar-mercado-livre': ['admin', 'socio', 'financeiro', 'expedicao', 'sac'],
    '/feed-25/buscar-categoria-mercado-livre': ['admin', 'socio', 'financeiro', 'expedicao', 'sac'],
    '/avisos': ['admin', 'socio'],
